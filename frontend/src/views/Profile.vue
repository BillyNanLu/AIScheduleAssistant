        ...
        <el-tabs v-model="activeTab" type="card">
          ...
          <el-tab-pane label="基本信息" name="basic">
            <el-descriptions :column="2" border>
              ...
              <el-descriptions-item label="注册时间">{{ formatDate(user.create_time) || '未知' }}</el-descriptions-item>
              <el-descriptions-item label="最近登录">{{ formatDate(user.last_login) || '未知' }}</el-descriptions-item>
            </el-descriptions>
          </el-tab-pane>
